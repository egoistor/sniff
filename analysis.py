...
from winpcapy import WinPcapDevices, WinPcap, WinPcapUtils
import time
...
def delPacket(win_pcap, param, header, pkt_data):
...
if __name__ == '__main__':
    ...
    WinPcapUtils.capture_on("Realtek PCIe GbE Family Controller", delPacket)
